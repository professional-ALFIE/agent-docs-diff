> 원본: https://vibekanban.com/docs/issue-management.md
...
> Create, organise, and track issues from first draft to done on the kanban board
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/oLzxcaVcX9J7SoPh/images/issue-mgmt-create-button.png?fit=max&auto=format&n=oLzxcaVcX9J7SoPh&q=85&s=7df1414122a426b8ac1b4646cc9e5a79" alt="Kanban board showing the New Issue button in the header and the plus button on a column" width="2988" height="1700" data-path="images/issue-mgmt-create-button.png" />
</Frame>

Use the **Team** and **Personal** tabs to switch between all project issues and only those assigned to you.

<Frame>
  <img src="https://mintcdn.com/vibekanban/oLzxcaVcX9J7SoPh/images/issue-mgmt-team-personal.png?fit=max&auto=format&n=oLzxcaVcX9J7SoPh&q=85&s=f825fae8d4d728bf1efc5574a211238e" alt="Filter bar showing the Team and Personal tabs" width="2990" height="1698" data-path="images/issue-mgmt-team-personal.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/oLzxcaVcX9J7SoPh/images/issue-mgmt-create-panel.png?fit=max&auto=format&n=oLzxcaVcX9J7SoPh&q=85&s=2eaeb0d811edda5c7a95fc0c8592c05e" alt="New issue panel with title field and description editor" width="2988" height="1700" data-path="images/issue-mgmt-create-panel.png" />
</Frame>
...
<Frame>
  <img style={{maxHeight: "300px"}} src="https://mintcdn.com/vibekanban/oLzxcaVcX9J7SoPh/images/issue-mgmt-description.png?fit=max&auto=format&n=oLzxcaVcX9J7SoPh&q=85&s=3ec6d1588253648c6ab36afe99979b7c" alt="Issue description editor with formatted text including headings and code blocks" width="1162" height="1334" data-path="images/issue-mgmt-description.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/oLzxcaVcX9J7SoPh/images/issue-mgmt-priority-tags.png?fit=max&auto=format&n=oLzxcaVcX9J7SoPh&q=85&s=952120ca02c9234c690f446877e39122" alt="Issue panel showing the priority dropdown and tags selector" width="2984" height="1696" data-path="images/issue-mgmt-priority-tags.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/oLzxcaVcX9J7SoPh/images/issue-mgmt-kanban-board.png?fit=max&auto=format&n=oLzxcaVcX9J7SoPh&q=85&s=cd7068e3a054607e53d2d5ed76cad2f9" alt="Kanban board showing issues being dragged between columns" width="2984" height="1696" data-path="images/issue-mgmt-kanban-board.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/oLzxcaVcX9J7SoPh/images/issue-mgmt-all-tab.png?fit=max&auto=format&n=oLzxcaVcX9J7SoPh&q=85&s=b1d206910a4cf11a7b6b58878b59b5ac" alt="All tab selected showing Backlog and Cancelled statuses alongside the default columns" width="2984" height="1696" data-path="images/issue-mgmt-all-tab.png" />
</Frame>
...
<Frame>
  <img style={{maxHeight: "300px"}} src="https://mintcdn.com/vibekanban/oLzxcaVcX9J7SoPh/images/issue-mgmt-sub-issues.png?fit=max&auto=format&n=oLzxcaVcX9J7SoPh&q=85&s=d43755393d2afc319d4b71bb212dd67d" alt="Sub-issues section showing child issues with mixed statuses" width="2984" height="1696" data-path="images/issue-mgmt-sub-issues.png" />
</Frame>
...
<Frame>
  <img style={{maxHeight: "300px"}} src="https://mintcdn.com/vibekanban/oLzxcaVcX9J7SoPh/images/issue-mgmt-link-workspace.png?fit=max&auto=format&n=oLzxcaVcX9J7SoPh&q=85&s=a5806dc362b53e209b861595233a4aa9" alt="Issue panel showing the Workspaces section with Create and link buttons" width="2984" height="1696" data-path="images/issue-mgmt-link-workspace.png" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Filtering & Sorting" icon="filter" href="/docs/cloud/filtering">
    Find issues quickly with search, filters, and sorting
  </Card>

  <Card title="Kanban Board" icon="table-columns" href="/docs/cloud/kanban-board">
    Learn more about the board layout and collaboration
  </Card>

  <Card title="Workspaces" icon="terminal" href="/docs/workspaces/index">

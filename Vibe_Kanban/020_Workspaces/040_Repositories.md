> 원본: https://vibekanban.com/docs/workspaces/repositories.md
...
<Warning>
  Changing the target branch may require rebasing your changes. See [Git Operations](/docs/workspaces/git-operations) if conflicts occur.
</Warning>
...
The working branch name is based on your task and branch prefix settings (configured in [General Settings](/docs/settings/general)).
...
* [Creating Workspaces](/docs/workspaces/creating-workspaces) - Setting up new workspaces with repositories
* [Git Operations](/docs/workspaces/git-operations) - Detailed guide to git commands
* [Multi-Repo & Sessions](/docs/workspaces/multi-repo-sessions) - Working across multiple repositories

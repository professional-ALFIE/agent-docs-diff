> 원본: https://vibekanban.com/docs/workspaces/slash-commands.md
...
> Use slash commands to run agent commands directly from the chat input

<Frame>
  <img src="https://mintcdn.com/vibekanban/L7cCO5FrWVLOFk8A/images/workspaces-slash-commands.png?fit=max&auto=format&n=L7cCO5FrWVLOFk8A&q=85&s=e5452d21f4cbe9726c1b6ce3e18f9b6c" alt="Slash command typeahead showing available commands when typing a forward slash" width="1652" height="1082" data-path="images/workspaces-slash-commands.png" />
</Frame>
...
* [Sessions](/docs/workspaces/sessions) - Managing conversation sessions
* [Supported Coding Agents](/docs/supported-coding-agents) - Agent setup and configuration

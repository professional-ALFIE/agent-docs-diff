> 원본: https://vibekanban.com/docs/integrations/vscode-extension.md
...
> Complete guide to using the Vibe Kanban extension with VSCode, Cursor, and Windsurf
...
<video controls className="w-full aspect-video rounded-xl" src="https://vkcdn.britannio.dev/vk-ide-extension-light.mp4" />

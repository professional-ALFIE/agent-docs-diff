> 원본: https://exa.ai/docs/reference/search-api-guide.md
...
<AccordionGroup>
  <Accordion title="Search types for any agent" description="Whether you're building a fast chatbot or a deep research tool, Exa has custom search types with appropriate latency-quality profiles, from ~250 ms instant search to 12-40 second deep-reasoning search.">
    | Type             | Speed         | Best For                                                               |
    | ---------------- | ------------- | ---------------------------------------------------------------------- |
  ...
  <Accordion title="10x token-efficient contents" description="LLMs just want dense information! At Exa, we train models that take full webpages and condense them into just the tokens an LLM needs. We can also use LLMs to process information on our end, returning structured outputs or grounded answers.">
    **LLM Outputs**
  ...
  <Accordion title="Category-specific search" description="Agents can parallel process gigantic quantities of precise information. Exa has custom indexes of 1B+ people, 50M+ companies, 350M+ publications (research papers, preprints, and more), and more. Use categories when you already know the retrieval surface you need.">
    | Category           | Best For                                                                    |
    | ------------------ | --------------------------------------------------------------------------- |
...
<AccordionGroup>
  <Accordion title="Web retrieval with highlights" description="Give any agent the ability to search the web in real time.">
    ```python theme={null}
    results = exa.search(
      "news about Iran",
      type="auto",
  ...
  <Accordion title="Filter by domain or path" description="Limit results to an entire domain or a specific section of a site.">
    ```python theme={null}
    results = exa.search(
  ...
  <Accordion title="Deep Search for data enrichment / structured output" description="Use deeper modes when you want Search to synthesize across sources and return structured output.">
    ```python theme={null}
    result = exa.search(
  ...
  <Accordion title="Company/People research" description="Find and enrich companies/people with dozens of fields.">
    ```python theme={null}

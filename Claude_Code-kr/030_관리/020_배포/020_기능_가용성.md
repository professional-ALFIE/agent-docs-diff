> 원본: https://code.claude.com/docs/ko/feature-availability.md
...
* **[Commands](/docs/ko/commands#all-commands)**:
  * `/design-sync` 및 `/import`와 그 `claude import` 서브명령 형식은 Amazon Bedrock, Google Cloud의 Agent Platform, Microsoft Foundry, AWS의 Claude Platform에서 사용할 수 없습니다.

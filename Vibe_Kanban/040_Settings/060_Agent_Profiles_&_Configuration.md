> 원본: https://vibekanban.com/docs/settings/agent-configurations.md
...
> Create reusable agent configurations with custom settings for planning mode, model selection, and permission levels that you can quickly switch between when creating task attempts
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/AarTdrkhni3X9r3h/images/settings-agents.png?fit=max&auto=format&n=AarTdrkhni3X9r3h&q=85&s=59f1a256d29a1128207b80ad49c27731" alt="Agent configuration form editor interface with finder-style layout" width="2032" height="1580" data-path="images/settings-agents.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/AarTdrkhni3X9r3h/images/settings-agents-create-button.png?fit=max&auto=format&n=AarTdrkhni3X9r3h&q=85&s=6bbe89e06f7e73c8d8b6d8215e0c80ec" alt="Configuration column showing the + button with Create new tooltip" width="2032" height="732" data-path="images/settings-agents-create-button.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/AarTdrkhni3X9r3h/images/settings-agents-create-dialog.png?fit=max&auto=format&n=AarTdrkhni3X9r3h&q=85&s=9555fc97d8b11e12a20b106ca2a51087" alt="Create New Configuration dialog with name field and clone option" width="1380" height="732" data-path="images/settings-agents-create-dialog.png" />
</Frame>
...
<Warning>
  Options prefixed with "dangerously\_" bypass safety confirmations and can perform destructive actions. Use with extreme caution.
</Warning>
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/pEEwVjsOqxHcbN64/images/settings-agents-env-vars.png?fit=max&auto=format&n=pEEwVjsOqxHcbN64&q=85&s=17b260231a2de47ced12d89048deb004" alt="Agent configuration form showing the Environment Variables section with KEY and value inputs" width="2984" height="1696" data-path="images/settings-agents-env-vars.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/QA35mU65cg2kMRzj/images/workspaces-agent-selection.png?fit=max&auto=format&n=QA35mU65cg2kMRzj&q=85&s=a6a727516d0fae460bfbbcc0ad40801d" alt="Chat input showing agent variant dropdown with Default, Approvals, Opus, and Plan options" width="1740" height="1246" data-path="images/workspaces-agent-selection.png" />
</Frame>

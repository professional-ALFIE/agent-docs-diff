> 원본: https://vibekanban.com/docs/integrations/mcp-server-configuration.md
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/BOKHhAFY6djVqiOL/images/vk-mcp-server-config.png?fit=max&auto=format&n=BOKHhAFY6djVqiOL&q=85&s=98ba1aa2a8635378d6040bf9df4224bf" alt="MCP Server configuration page showing agent selection, JSON configuration, and popular servers" width="2984" height="1696" data-path="images/vk-mcp-server-config.png" />
</Frame>

> 원본: https://vibekanban.com/docs/workspaces/multi-repo-sessions.md
...
Access repository-specific actions via the [command bar](/docs/workspaces/command-bar):
...
* [Git Operations](/docs/workspaces/git-operations) - Managing git across repositories
* [Command Bar](/docs/workspaces/command-bar) - Quick actions for repo management

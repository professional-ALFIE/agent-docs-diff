> 원본: https://vibekanban.com/docs/workspaces/index.md
...
> A redesigned task execution experience with multi-repo support, multiple agent sessions, and an integrated preview browser

<Frame>
  <img style={{maxHeight: "400px"}} src="https://mintcdn.com/vibekanban/QA35mU65cg2kMRzj/images/workspaces-overview.png?fit=max&auto=format&n=QA35mU65cg2kMRzj&q=85&s=ae39f2a1b0eefe555356aee4476336ba" alt="Workspaces UI showing the four-panel layout with workspace sidebar, conversation, changes panel, and details sidebar" width="3430" height="1348" data-path="images/workspaces-overview.png" />
</Frame>
...
<CardGroup cols={2}>
  <Card title="Multi-Repository Support" icon="folder-tree" href="/docs/workspaces/multi-repo-sessions">
  ...
  <Card title="Multiple Sessions" icon="messages" href="/docs/workspaces/multi-repo-sessions">
  ...
  <Card title="Integrated Terminal" icon="rectangle-terminal" href="/docs/workspaces/interface#terminal-section">
    Built-in terminal for running commands directly in your workspace. New to the Workspaces UI.
  </Card>

  <Card title="Workspace Notes" icon="note-sticky" href="/docs/workspaces/interface#notes-section">
    Notes for each workspace to document important information. New to the Workspaces UI.
  </Card>

  <Card title="Command Bar" icon="command" href="/docs/workspaces/command-bar">

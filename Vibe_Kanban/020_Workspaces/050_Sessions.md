> 원본: https://vibekanban.com/docs/workspaces/sessions.md
...
<Note>
  Git handles most conflicts automatically. For complex conflicts, see [Git Operations](/docs/workspaces/git-operations).
</Note>

...
OpenCode Go에는 다음과 같은 기본 한도가 포함됩니다.

- **5시간 한도** — 사용량 $12
- **주간 한도** — 사용량 $30
- **월간 한도** — 사용량 $60

실제 적용되는 할당량은 모델마다 다릅니다. 아래 표를 참조하세요.
...
- Omen Alpha — 요청당 입력 300, 캐시 40,000, 출력 토큰 100
...
Go에서는 월 $10를 지불하며, 대부분의 모델에 대해 그 6배의 사용량을 제공하는 것을 목표로 합니다.
...
- **DeepSeek V4 Flash:** ZDR 계약은 매월 갱신됩니다. 현재 계약은 2026년 9월 30일까지 유효합니다.

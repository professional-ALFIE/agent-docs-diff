> 원본: https://vibekanban.com/docs/cloud/issues.md
...
2. The issue is created with a linked [workspace](/docs/workspaces/index)
3. You can start working with coding agents right away

See [Workspaces](/docs/workspaces/index) to learn more about working with coding agents.
...
Shows development workspaces linked to this issue. [Workspaces](/docs/workspaces/index) are where coding agents do their work.
...
<Info>
  Selection works in both the [kanban board](/docs/cloud/kanban-board) and [list view](/docs/cloud/list-view). In list view, checkboxes appear on hover for each row. In the kanban board, use modifier keys or keyboard shortcuts to select cards.
</Info>
...
* [Kanban Board](/docs/cloud/kanban-board) - Moving and organising issues on the board
* [Filtering & Sorting](/docs/cloud/filtering) - Finding issues quickly
* [Customising Your Board](/docs/cloud/customisation) - Configuring statuses and tags
* [Workspaces](/docs/workspaces/index) - Working with coding agents

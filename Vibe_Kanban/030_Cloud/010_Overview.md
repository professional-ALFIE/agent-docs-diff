> 원본: https://vibekanban.com/docs/cloud/index.md
...
> Collaborate with your team in real-time with Cloud features
...
<Card title="Full Getting Started Guide" icon="rocket" href="/docs/cloud/getting-started">
...
<CardGroup cols={2}>
  <Card title="Issues" icon="circle-dot" href="/docs/cloud/issues">
    Create and manage issues to track your work
  </Card>

  <Card title="Kanban Board" icon="columns" href="/docs/cloud/kanban-board">
    Use the board to visualise and manage progress
  </Card>

  <Card title="Team Members" icon="user-plus" href="/docs/cloud/team-members">
    Invite colleagues and manage permissions
  </Card>

  <Card title="Customisation" icon="palette" href="/docs/cloud/customisation">

> 원본: https://vibekanban.com/docs/cloud/projects.md
...
You can customise these statuses - rename them, change colours, add new ones, or hide ones you don't use. See [Customising Your Board](/docs/cloud/customisation) for details.
...
<Tip>
  You can also manage projects from **Settings** → **Remote Projects**. See [Remote Projects Settings](/docs/settings/remote-projects) for more details.
</Tip>
...
For more details on managing projects, see [Remote Projects Settings](/docs/settings/remote-projects).
...
* [Customising Your Board](/docs/cloud/customisation) - Configuring columns and display settings
* [Remote Projects Settings](/docs/settings/remote-projects) - Managing projects from Settings

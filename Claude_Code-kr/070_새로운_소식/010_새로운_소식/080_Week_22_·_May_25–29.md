> 원본: https://code.claude.com/docs/ko/whats-new/2026-w22.md
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="/docs/ko/workflows">동적 워크플로우</a>
</div>
...
<div className="digest-feature">
  ...
  <a className="digest-feature-link" href="/docs/ko/fast-mode#understand-the-cost-tradeoff">빠른 모드 가격</a>
</div>

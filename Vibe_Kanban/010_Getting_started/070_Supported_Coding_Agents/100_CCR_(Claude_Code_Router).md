> 원본: https://vibekanban.com/docs/agents/ccr.md
...
> Set up CCR to orchestrate multiple Claude Code models
...
* GitHub: [https://github.com/musistudio/claude-code-router](https://github.com/musistudio/claude-code-router)
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/v9mmgerrTV5aFw1Z/images/ccr-openrouter-ui.png?fit=max&auto=format&n=v9mmgerrTV5aFw1Z&q=85&s=4c8443095ac698c113048cf6d05c95a0" alt="OpenRouter configured in CCR UI" width="2178" height="1844" data-path="images/ccr-openrouter-ui.png" />
</Frame>

### Example: CCR model mapping (default/background/think/etc.)

<Frame>
  <img src="https://mintcdn.com/vibekanban/v9mmgerrTV5aFw1Z/images/ccr-config-example.png?fit=max&auto=format&n=v9mmgerrTV5aFw1Z&q=85&s=8d4cf7695a4800c4407654108a03adcc" alt="CCR models configuration example" width="1418" height="1110" data-path="images/ccr-config-example.png" />
</Frame>
...
See the [Agent Profiles & Variants](/docs/settings/agent-configurations) guide for managing agent configurations.
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/v9mmgerrTV5aFw1Z/images/vk-ccr-agent-config.png?fit=max&auto=format&n=v9mmgerrTV5aFw1Z&q=85&s=cadfaeaaba52c2c56aa377d2303e5867" alt="Claude Code agent configuration in Vibe Kanban" width="2198" height="1710" data-path="images/vk-ccr-agent-config.png" />
</Frame>

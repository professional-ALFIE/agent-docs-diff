> 원본: https://exa.ai/docs/websets/api/websets/list-all-websets.md
  ...
  /v0/websets:
    ...
    get:
      ...
      description: >-
        ...
        You can filter results using the `search` parameter to find Websets by
        ID, external ID, or title.

...
| Sonnet 5             | Fable, Opus 4.7 이상, Sonnet 5 | Sonnet 4.6 조언자는 거부되며, Opus 4.6 조언자를 사용한 요청은 API 오류로 실패합니다                     |
| Opus 4.6             | Fable, Opus, Sonnet 5        | Sonnet 4.6 조언자는 거부됩니다                                                         |
| Opus 4.7 또는 Opus 4.8 | Fable, Opus 4.7 이상           | Opus 4.6 또는 Sonnet 조언자는 거부됩니다                                                 |
| Opus 5               | Fable, Opus 5                | Opus 4.6 또는 Sonnet 조언자는 거부되며, Opus 4.7 또는 Opus 4.8 조언자를 사용한 요청은 API 오류로 실패합니다 |
| Fable 5              | Fable 5.1 또는 Fable 5         | Opus 또는 Sonnet 조언자는 거부됩니다                                                     |
| Fable 5.1            | Fable 5.1                    | Opus 또는 Sonnet 조언자는 거부되며, Fable 5 조언자를 사용한 요청은 API 오류로 실패합니다                  |
...
* 표에서 API 오류로 실패하는 것으로 나열된 조언자의 경우, Claude Code는 이를 첨부하고 API가 이를 거부합니다. 모든 요청이 `'<advisor model>'은(는) 요청 모델이 '<main model>'일 때 조언자로 사용될 수 없습니다`로 실패하며, `/advisor`로 조언자를 변경하거나 끌 때까지 계속됩니다.

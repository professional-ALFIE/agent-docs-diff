> 원본: https://vibekanban.com/docs/integrations/vibe-kanban-mcp-server.md
...
<Note>
  This page covers connecting **external MCP clients** to Vibe Kanban's MCP server. For configuring MCP servers **within** Vibe Kanban for your coding agents, see the [MCP Server Configuration](/docs/integrations/mcp-server-configuration) guide.
</Note>
...
This works if you're adding the Vibe Kanban MCP server to any [supported coding agent](/docs/supported-coding-agents) **within** Vibe Kanban.
...
1. **Create a Planning Issue**: Create an issue with a custom agent profile configured with a planning prompt. See [Agent Configurations](/docs/settings/agent-configurations) for details on creating custom profiles.

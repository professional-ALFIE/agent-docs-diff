> 원본: https://opencode.ai/docs/go.md
...
Effective allowance varies by model; see the table below.
...
- Omen Alpha — 300 input, 40,000 cached, 100 output tokens per request

> 원본: https://vibekanban.com/docs/cloud/kanban-board.md
...
> Visualise and manage your work with the kanban board
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/TDM0xx2duuZqyvY7/images/cloud/project-kanban-board.png?fit=max&auto=format&n=TDM0xx2duuZqyvY7&q=85&s=d30b4023136defc030f6c1b20e80abe6" alt="Kanban board showing columns with issue cards" width="2980" height="1700" data-path="images/cloud/project-kanban-board.png" />
</Frame>
...
You can [customise these columns](/docs/cloud/customisation) - add new ones, rename them, change colours, or hide/show ones you need.
...
Click any card to open the full [issue panel](/docs/cloud/issues).
...
<Frame>
  <img src="https://mintcdn.com/vibekanban/TDM0xx2duuZqyvY7/images/cloud/drag-drop.png?fit=max&auto=format&n=TDM0xx2duuZqyvY7&q=85&s=b7082d73ab6040c4abe0e8e162b36e2b" alt="Dragging an issue card between columns" width="2074" height="1592" data-path="images/cloud/drag-drop.png" />
</Frame>
...
| **All**                          | [List View](/docs/cloud/list-view) | All issues including hidden statuses  |
| **Backlog**, **Cancelled**, etc. | [List View](/docs/cloud/list-view) | Issues in that specific hidden status |

<Info>
  Hidden status tabs (like Backlog or Cancelled) only appear if you've hidden those statuses in [Display Settings](/docs/cloud/customisation). This is useful for keeping your board clean while still having quick access to archived or backlogged items.
</Info>
...
When two or more issues are selected, a **bulk action bar** appears at the bottom of the screen. You can change the status, priority, or assignees of all selected issues at once, or delete them. See [Selecting Multiple Issues](/docs/cloud/issues#selecting-multiple-issues) for full details.
...
* [Hide the status](/docs/cloud/customisation) in Display Settings if you don't need it on the board

<Frame>
  <img style={{maxHeight: "300px"}} src="https://mintcdn.com/vibekanban/TDM0xx2duuZqyvY7/images/cloud/empty-column.png?fit=max&auto=format&n=TDM0xx2duuZqyvY7&q=85&s=bf4d11eb6fb38d543c89230da3ff7e74" alt="Empty column showing the + button to create a new issue" width="1094" height="1592" data-path="images/cloud/empty-column.png" />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="A column is missing">
    The column might be hidden. Go to [Display Settings](/docs/cloud/customisation) and check if the status is set to hidden. Toggle it back to visible.
  </Accordion>
...
* [List View](/docs/cloud/list-view) - Alternative tabular view for issues
* [Issues](/docs/cloud/issues) - Creating and editing issues
* [Filtering & Sorting](/docs/cloud/filtering) - Finding issues quickly
* [Customising Your Board](/docs/cloud/customisation) - Configuring columns and display

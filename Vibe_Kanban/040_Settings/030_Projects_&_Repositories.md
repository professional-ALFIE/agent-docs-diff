> 원본: https://vibekanban.com/docs/settings/projects-repositories.md
...
<Card title="Browser Testing" icon="eye" href="/docs/browser-testing">
...
<CardGroup cols={2}>
  ...
  <Card title="Multi-Repository Sessions" icon="folder-tree" href="/docs/workspaces/multi-repo-sessions">

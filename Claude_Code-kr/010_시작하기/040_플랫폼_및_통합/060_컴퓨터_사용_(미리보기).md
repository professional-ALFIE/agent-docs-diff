...
한 번에 하나의 세션만 컴퓨터를 사용할 수 있습니다. 세션은 첫 번째 컴퓨터 사용 작업에서 머신 전체 잠금을 획득하고 작업이 완료될 때가 아니라 세션이 종료될 때 해제합니다. 두 번째 세션의 컴퓨터 사용은 잠금을 유지하는 세션의 이름을 지정하는 오류로 실패합니다. 먼저 해당 세션을 종료합니다.
